...
class NodeObject(object):
    ...
    def create_property(self, name, value, items=None, range=None, widget_type=None, widget_tooltip=None, tab=None):
        """
        ...
        self.model.add_property(name, value, items, range, widget_type, widget_tooltip, tab)
