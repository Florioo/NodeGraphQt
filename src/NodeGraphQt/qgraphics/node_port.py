...
from NodeGraphQt.qgraphics.node_base import AbstractNodeItem


class PortNodeGraphItem(AbstractNodeItem):
    """
    ...
    def __init__(self, name="group port", parent=None):
        super(PortNodeGraphItem, self).__init__(name, parent)
    ...
    def paint(self, painter, option, widget):
        ...
        edge_size = 30
        edge_rect = QtCore.QRectF(rect.width() - (size * 1.7), rect.center().y() - (edge_size / 2), 4, edge_size)
